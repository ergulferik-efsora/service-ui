...
export const LinearSettings = (props) => {
  ...
  const authFieldsConfig = [
    ...
    },
    {
      ...
      message: formatMessage(messages.teamKeyLabel),
    },
    {
      value: formatMessage(messages.apiKeyLabel),
      message: formatMessage(messages.apiKeyLabel),
    },
  ];
